...
export function CompleteModal({
  ...
  return (
    <div className="fixed inset-0 z-[9999] flex items-center justify-center bg-black/80 px-4 backdrop-blur-sm">
      <div className="max-h-[90vh] w-full max-w-lg overflow-y-auto border border-green-400 bg-black p-5 shadow-[0_0_40px_rgba(74,222,128,0.35)] sm:p-6">
        ...
        <button
          onClick={onReset}
          className="w-full border border-green-400 bg-green-400 px-6 py-3 font-bold text-black transition hover:bg-black hover:text-green-400"
        >
          TRY AGAIN
        </button>
      </div>
